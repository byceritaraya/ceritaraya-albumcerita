...
const en = {
  ...
  albumView: {
    ...
    autoPublishCountdown: 'Album goes public in',
  ...
  filmRoll: {
    ...
    developWarning: 'Are you sure you want to develop now? Your remaining roll cannot be used again once developed.',
    developWarningTitle: 'Develop Now?',
    developWarningCancel: 'Not Yet',
  ...
  adminEditEvent: {
    ...
    optional: '(optional)',
    theme: 'Theme',
    autoPublishAt: 'Auto Publish At (Optional)',
    autoPublishHelper: 'Set a time for the album to automatically become public.',
    retention: 'Retention',
