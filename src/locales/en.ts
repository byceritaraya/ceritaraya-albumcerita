...
const en = {
  ...
  upload: {
    ...
    successSingle: '1 moment shared! ✨',
    successMultiple: (n: number) => `${n} moments shared! ✨`,
    partialFail: (ok: number, fail: number) =>
      `${ok} shared, ${fail} couldn't upload. Tap to retry those.`,
    allFailed: 'Something went wrong. Tap to try again.',
    uploadError: 'Upload failed',
    allUploaded: 'All moments have been shared.',
    quotaFull: "You've used all your shots for this event.",
  ...
  albumView: {
    ...
    emptyGuest: 'Be the first to capture a memory!',
    emptyHost: 'Moments your guests capture will appear here.',
  ...
  filmRoll: {
    ...
    rollShared: 'Your roll has been shared! ✨',
    noFrames: 'No frames captured yet.',
    rollFullSubtitle: "You've captured all your frames.",
  ...
  publishModal: {
    ...
    body: `Only visible moments will appear in the public album.\n\nGuests won't need a PIN to view the published memories.`,
    cancel: 'Not Yet',
    confirm: 'Publish Album',
    publishing: 'Publishing Album...',
    successTitle: 'Album Published',
    successBody: 'Your guests can now enjoy every curated moment.',
  },
  ...
  gallery: {
    ...
    momentTakers: 'Moment Takers',
    emptyTitle: 'No Moments Yet',
    emptyBody: 'Be the first to share a memory!',
  },
