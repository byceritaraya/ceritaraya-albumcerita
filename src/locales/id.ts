...
const id: Translations = {
  ...
  upload: {
    ...
    successSingle: '1 momen berhasil dibagikan! ✨',
    successMultiple: (n: number) => `${n} momen berhasil dibagikan! ✨`,
    partialFail: (ok: number, fail: number) =>
      `${ok} berhasil, ${fail} gagal diunggah. Ketuk untuk mencoba ulang.`,
    allFailed: 'Terjadi kesalahan. Ketuk untuk mencoba lagi.',
    uploadError: 'Gagal mengunggah',
    allUploaded: 'Semua momen sudah dibagikan.',
    quotaFull: 'Kamu sudah menggunakan semua jatah fotomu.',
  ...
  albumView: {
    ...
    hide: 'Sembunyikan',
    unhide: 'Tampilkan',
    emptyTitle: 'Belum Ada Momen',
    emptyGuest: 'Jadilah yang pertama mengabadikan kenangan!',
    emptyHost: 'Momen dari tamumu akan muncul di sini.',
  ...
  filmRoll: {
    ...
    rollShared: 'Rol film kamu telah dibagikan! ✨',
    noFrames: 'Belum ada frame yang terabadikan.',
    rollFullSubtitle: 'Kamu sudah menggunakan semua frame.',
  ...
  // ─── Publish Modal ──────────────────────────────────────────────────────────
  publishModal: {
    title: 'Siap Dipublikasikan?',
    body: `Hanya momen yang terlihat yang akan tampil di album publik.\n\nTamu tidak perlu PIN untuk melihat kenangan yang sudah dipublikasikan.`,
    cancel: 'Belum Sekarang',
    confirm: 'Terbitkan Album',
    publishing: 'Menerbitkan Album...',
    successTitle: 'Album Diterbitkan',
    successBody: 'Semua tamu kini bisa menikmati setiap momen yang telah dikurasi.',
  },
  ...
  gallery: {
    ...
    momentTakers: 'Moment Takers',
    emptyTitle: 'Belum Ada Momen',
    emptyBody: 'Jadilah yang pertama berbagi kenangan!',
  },
