...
const id: Translations = {
  ...
  albumView: {
    ...
    yourMoments: 'Momenmu',
    autoPublishCountdown: 'Album akan rilis dalam',
  ...
  filmRoll: {
    ...
    developWarning: 'Kamu yakin ingin develop sekarang? Sisa roll kamu tidak akan bisa digunakan kembali setelah di develop.',
    developWarningTitle: 'Develop Sekarang?',
    developWarningCancel: 'Belum',
    developWarningConfirm: 'Develop',
  },
  ...
  adminEditEvent: {
    ...
    optional: '(opsional)',
    theme: 'Tema',
    autoPublishAt: 'Waktu Rilis Otomatis (Opsional)',
    autoPublishHelper: 'Atur waktu kapan album akan dipublikasikan secara otomatis.',
